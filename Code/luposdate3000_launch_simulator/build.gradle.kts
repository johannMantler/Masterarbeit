...
evaluationDependsOn(":src:luposdate3000_simulator_iot")
evaluationDependsOn(":src:luposdate3000_simulator_core")
evaluationDependsOn(":src:luposdate3000_simulator_db")
...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation(project(":src:luposdate3000_simulator_iot"))
                implementation("org.jetbrains.kotlinx:kotlinx-datetime:0.2.1")
                implementation("org.jetbrains.kotlinx:kotlinx-serialization-json:1.2.1")
                implementation(project(":src:luposdate3000_simulator_core"))
                implementation(project(":src:luposdate3000_simulator_db"))
    ...
    sourceSets["commonMain"].kotlin.srcDir("D:/ideaprojects/luposdate3000/src/xxx_generated_xxx/src/luposdate3000_launch_simulator/src/commonMain/kotlin")
    sourceSets["commonMain"].resources.srcDir("D:/ideaprojects/luposdate3000/src/xxx_generated_xxx/src/luposdate3000_launch_simulator/src/commonMain/resources")
    sourceSets["jvmMain"].kotlin.srcDir("D:/ideaprojects/luposdate3000/src/xxx_generated_xxx/src/luposdate3000_launch_simulator/src/jvmMain/kotlin")
    sourceSets["jvmMain"].resources.srcDir("D:/ideaprojects/luposdate3000/src/xxx_generated_xxx/src/luposdate3000_launch_simulator/src/jvmMain/resources")
}
application{
